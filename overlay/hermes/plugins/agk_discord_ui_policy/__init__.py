...
def policy_prompt(_session_info: dict | None = None) -> str:
    return (
        ...
        "repeat the same question in prose, an embed, a modal, and a Hermes input block. Prefer progressive "
        "disclosure over dense menus, decorative embeds, icon grids, or walls of text. "
