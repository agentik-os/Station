...
_GLOBAL_DEFAULTS: dict[str, Any] = {
    ...
    # One persistent plan-driven action card per non-trivial Discord turn.
    # Opt-in: platforms/profiles enable it explicitly after deploying the
    # Station action-message runtime.
    "action_messages": False,
