...
class TurnContext:
    ...
    # Discord Station action card: created after the canonical todo plan is
    # applied, edited in place for the rest of the turn, and persisted across
    # gateway restarts by gateway.station_action_message.
    station_action_message: Any = None
    station_action_loop: Any = None
    station_action_futures: list = field(default_factory=list)
