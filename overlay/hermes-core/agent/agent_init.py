...
def init_agent(
    ...
    # Meaningful progress is separate from process liveness. Periodic tool
    # heartbeats may refresh _last_activity_ts, but must not keep a wedged turn
    # alive forever in the gateway watchdog.
    agent._last_progress_ts = agent._last_activity_ts
    agent._last_progress_desc = agent._last_activity_desc
